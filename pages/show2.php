...
<div class="navbar">
  <div class="navbar-inner ">
    <ul class="nav">
      <li><a href="show.php">الكتب الصادرة</a></li>
      <li class="active"><a href=show2.php>الكتب الواردة</a></li>
    </ul>
  </div>
...
<legend class="text-error">جدول الكتب الواردة المخزونة</legend>
...
<?php
    ...
    $query = "SELECT * FROM post_ingoing LIMIT $start_from, $num_rec_per_page"; 
    ...
    while($row = mysqli_fetch_assoc($select_query)){
        ...
        echo "<a href='show_post2.php?show={$id}' target='_blank''><button class='btn btn-primary' type='button'>عرض</button></a>&nbsp;&nbsp;";
...
<div class="pagination  pagination-large">
   ...
   <?php 
    $sql = "SELECT * FROM post_ingoing"; 
    $select_query=mysqli_query($connection,$sql);
    $total_pages = ceil(mysqli_num_rows($select_query) / $num_rec_per_page); 
     
    echo "<ul>";
    echo "<li><a href='show2.php?page=1''>البداية</a></li>"; // Goto 1st page  

    for ($i=1; $i<=$total_pages; $i++) { 
                echo "<li><a href='show2.php?page=".$i."'>".$i."</a> </li>"; 
    }; 
    echo "<li><a href='show2.php?page=$total_pages'>النهاية</a></li>"; // Goto last page
