      ...
      if(empty($errors)==true){
        ...
        //$image = addslashes(file_get_contents($_FILES['image']['tmp_name']));
         ...
         // echo "Success";
          ...
          $query = "INSERT INTO post_outgoing (id,name,date,number,content,ministry_id,office_id,storage_location_id,note,content_type_id,images_id) VALUES (NULL,'{$name}','{$date}','{$number}','{$content}','{$ministry_id}','{$office_id}','{$storage_location_id}','{$note}','{$content_type_id}','{$images_id}');";
         // echo $query;
      }else{
         print_r($errors);
      }
        ...
        $query = "INSERT INTO post_outgoing (id,name,date,number,content,ministry_id,office_id,storage_location_id,note,content_type_id,images_id) VALUES (NULL,'{$name}','{$date}','{$number}','{$content}','{$ministry_id}','{$office_id}','{$storage_location_id}','{$note}','{$content_type_id}','');";
    }
